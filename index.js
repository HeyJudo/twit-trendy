...
// "dateOptions" Object with allow us to change the format retrieve from CurrentDate
let dateOptions = {year: 'numeric', month: 'long', day: "numeric"};

//Will allow us to change the format to US time using the "DataOptions" object
...
const options = {
	method: 'POST',
	headers: {
		'x-rapidapi-key': '63891d6bf2msh8bc8b598dc345bcp141e41jsnebb9a7f58b5e',
		'x-rapidapi-host': 'twitter-trends5.p.rapidapi.com'
	},
	body: data
};

// // Dummy Data to commment out 
// let myPost = {
...
// //Print each individual elements in the graphData
// // Syntax: for(inital; condition; increment or decrement)
// for (let i = 0; i < 2; i++){
...
// //This will create a topics variable that contains the object.name properties 
// let topics = graphData.map(object => {
// 	console.log(object); 
// 	console.log(object.name);
// 	return object.name; 
...
// //This will create volumes variable that will contain object.volume valeus
